    ...
    <div className=" hide-scrollbar font-roboto lg:h-[calc(100vh-108px)] md:h-[calc(100vh-108px)] lg:overflow-y-scroll md:overflow-y-scroll   md:hide-scrollbar  lg:hide-scrollbar dark:bg-zinc-900 md:col-span-2 lg:col-span-3 justify-self-center  w-full md:p-2  p-4">
      <div className="dark:bg-zinc-800 rounded-xl justify-self-center w-full p-4">
        ...
        <div className="lg:flex">
          <div className=" p-3 bg-gray-300 dark:bg-zinc-900 rounded-xl justify-self-center w-full lg:h-52 m-2 lg:ml-0">
        ...
        <div className="lg:flex">
          <div className=" p-3 lg:ml-0 m-2 bg-gray-300 dark:bg-zinc-900 rounded-xl justify-self-center w-full lg:h-40">
            <p className="opacity-80    dark:opacity-25 text-sm p-1 lg:text-lg ">
              Humidity
            </p>
          ...
          <div className=" p-3 m-2 bg-gray-300 dark:bg-zinc-900 rounded-xl justify-self-center w-full lg:h-40">
            <p className="opacity-80    dark:opacity-25 text-sm p-1 lg:text-lg ">
              Visibility
            </p>
            <div className="flex justify-between lg:p-0 p-3  lg:h-25">
          ...
          <div className=" p-3 m-2 lg:mr-0 bg-gray-300 dark:bg-zinc-900 rounded-xl justify-self-center w-full lg:h-40">
